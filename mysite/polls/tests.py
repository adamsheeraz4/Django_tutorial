...
class QuestionModelTests(TestCase):
    ...
    # handles cases where question is more than a day old
    ...
    # handles the case where the question is recent (posted today)
...
def create_question(question_text, days):
    ...
    return Question.objects.create(question_text=question_text,pub_datet=time)
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        ...
        """
        #creates question, backdated 30 days
    ...
    def test_two_past_question(self):
        """
        The questions index page may display multiple questions, we want from most recent to least recent
        """
...
class QuestionDetailViewTests(Testcase):
    ...
    def test_past_question(self):
        """
        The detail view of a question with a pub_date in the past dispalys the question's text
        """
